...
data class LayerDto(
    ...
    // ── TextLayer ────────────────────────────────────────────────────────────
    val text: String? = null,    val richTextSpans: List<RichTextSpanDto> = emptyList(),
    val textSize: Float? = null,
    ...
    val wrapTextEnabled: Boolean? = null,
    ...
    val strokeAlignment: String? = null,
    val strokeStyle: String? = null,
    val strokeJoin: String? = null,
    val strokeGradientEnabled: Boolean? = null,
    val strokeGradient: GradientColorDto? = null,
    val stroke2Enabled: Boolean? = null,
    val stroke2Width: Float? = null,
    val stroke2Color: Int? = null,
    ...
    /** Legacy (proyek lama): radius blur emboss → dimigrasikan ke [embossBevel]. */
    val embossBlurRadius: Float? = null,
    val embossIntensity: Float? = null,
    val embossBevel: Float? = null,
    val neonEnabled: Boolean? = null,
    val neonColor: Int? = null,
    val neonRadius: Float? = null,
    val neonIntensity: Float? = null,
    val neonCoreEnabled: Boolean? = null,
    ...
    val shapeStrokeAlignment: String? = null,
    val shapeStrokeGradientEnabled: Boolean? = null,
    val shapeStrokeGradient: GradientColorDto? = null,
